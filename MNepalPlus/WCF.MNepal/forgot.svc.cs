...
namespace WCF.MNepal
{
    ...
    public class forgot
    {
                    ...
                    if (UserNameCheck.IsValidUserNameForgotPassword(userName))
                    {
                        ...
                        else
                        {
                            if (LoginUtils.GetPasswordBlockTime(userName))
                            {
                                ...
                                //result = "You have already attempt 3 times with wrong password,Please try again after 10 minutes";
                                ...
                                mnlg.ResponseStatus(HttpStatusCode.ExpectationFailed, replyMessage.Response);
                            ...
                            else
                            {
                                ...
                                OTPLog.Message = code;
                                OTPLog.Purpose = "Forgot Pin";

                                CustCheckUtils.LogOTP(OTPLog);

                                
                                statusCode = "200";
                                message = "Successfully send otp code"; // code;
                            }
                        }
                    }
                    else
        ...
        public string FPwd(Stream input)
        {
            ...
            if ((sessionID == "null") || (sessionID == "") || (votp == "") || (tid == "null") || (sc == "null") || (mobile == "null") || (npwd == "null") ||
            (src == "null"))
                {
                    statusCode = "400";
                    message = "Parameters Missing/Invalid";
            ...
            else
                {
                    ...
                    if (votp == pin)
                    {
                        ...
                        //start for status code 417
                        else if (LoginUtils.GetPINBlockTime(mobile)) //check if blocktime is greater than current time 
                        {
                            //message = LoginUtils.GetMessage("03");
                            ...
                            statusCode = "417";
                            replyMessage.Response = LoginUtils.GetMessage("03"); 
