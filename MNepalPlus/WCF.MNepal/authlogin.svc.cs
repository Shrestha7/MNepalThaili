    ...
    public class authlogin
    {
        ...
        public IEnumerable<LoginAuth> GetUserAuthentication(Stream input) //List<LoginAuth>
        {
            ...
            if ((userName != null) && (password != null) && (deviceId != null) && (code == null) || (code == ""))//
            {
                ...
                {
                    obj.Status = 400;
                    obj.Message = LoginUtils.GetMessage("02");
                    //obj.Message = "Your Account has been Blocked for 10 minutes. Please try again Later.";
                    Name = "";
                    UserType = "";
                    obj.VerificationCode = 0;
                    IsFirstLogin = "";
        ...
        {
            //string url = "http://smsvas.mos.com.np/PostSMS.ashx?QueueId=&TelecomId=2&KeywordId=3&Password=mnepal120&From=37878" + "&To=" + mobile + "&message=Your Verification code is " + password + ". Close this message and enter code to activate account.\n-MNepal";
            string url = System.Web.Configuration.WebConfigurationManager.AppSettings["MNepalSMSServerUrl"] + "&To=" + mobile + "&message=Your Verification code is " + password + ". Close this message and enter code to activate account.\n-NIBL Thaili";
        ...
        {
            //string url = "http://smsvas.mos.com.np/PostSMS.ashx?QueueId=&TelecomId=2&KeywordId=3&Password=mnepal120&From=37878" + "&To=" + mobile + "&message=Your Verification code is " + password + ". Close this message and enter code to activate account.\n-MNepal";
            string url = System.Web.Configuration.WebConfigurationManager.AppSettings["MNepalNTCSMSServerUrl"] + "&To=" + mobile + "&message=Your Verification code is " + password + ". Close this message and enter code to activate account.\n-NIBL Thaili";
            var request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
            request.ContentType = "application/x-www-form-urlencoded";
            //Get response from server
