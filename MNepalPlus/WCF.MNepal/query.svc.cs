...
namespace WCF.MNepal
{
    ...
    public class query
    {
        ...
        public string balance(string tid, string sc, string mobile, string sa, string pin, string src) //string
        {
            string result = "";
            ...
            string ouputString = pin.Replace(" ", "+");
            pin = ouputString.ToString();

            //DataTable dtableCheckPin = LoginUtils.CheckPin(mobile, pin);
        ...
        private string LookINTOResponseTableForMiniStatement(string tid)
        {
            ...
            string sql = "select MiniStmntRec as MiniStmntRec from MNResponse (NOLOCK) where TraceNo = '" + newString + "'";
            try
            {
        ...
        private string getBankAccountFromMobile(string contactNumber)
        {
            ...
            string sql = "SELECT * FROM dbo.v_MNClientDetail (NOLOCK) WHERE ContactNumber1 ='" + contactNumber + "' AND HasBankKYC='T'";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        private MNClientKyc getMNCLientKycName(string clientcode)
        {
            ...
            string sql = "SELECT * FROM MNClientKYC (NOLOCK) where ClientCode = '" + clientcode + "'";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        public string registration(Stream input)
        {
            ...
            if (response.StatusCode == HttpStatusCode.OK)
            {
                try
                {
                    ...
                    //var content = client.DownloadString("http://smsvas.mos.com.np/PostSMS.ashx?QueueId=&TelecomId=2&KeywordId=3&Password=mnepal120&From=37878&To=" + "977" + createnewuser.umobile.Trim() + "&message=" + messagereply + "");
        ...
        private ClientKYCDoc getMNCLientKycDoc(string clientcode)
        {
            ...
            string sql = "SELECT * FROM MNClientKYCDoc (NOLOCK) where ClientCode = '" + clientcode + "'";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        private ClientKYCDoc getMNMerchantKycDoc(string clientcode)
        {
            ...
            string sql = "SELECT * FROM MNMerchantKYCDoc (NOLOCK) where ClientCode = '" + clientcode + "'";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        private MNClient getMNCLientCodeByNumber(string contactNumber)
        {
            ...
            string sql = "SELECT * FROM dbo.v_MNClientDetail (NOLOCK) WHERE ContactNumber1 ='" + contactNumber + "'";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        public string getDistrictName(string id)
        {
            ...
            string sql = "select Name from MNDistrict (NOLOCK) where DistrictID='" + id + "'";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        private string GetSourceBankAccount(string mobile)
        {
            string result = "";
            string conStr = System.Configuration.ConfigurationManager.ConnectionStrings[MNepalDBConnectionStringProvider.GetConnection()].ConnectionString;
            string sql = "SELECT BankAccountNumber from MNBankAccountMap (NOLOCK) WHERE IsDefault=1 AND ClientCode in (SELECT ClientCode FROM MNClientContact (NOLOCK) WHERE ContactNumber1 = '" + mobile + "')";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
        ...
        private string GetSourceWalletAccount(string mobile)
        {
            string result = "";
            string conStr = System.Configuration.ConfigurationManager.ConnectionStrings[MNepalDBConnectionStringProvider.GetConnection()].ConnectionString;
            string sql = "SELECT WalletNumber from MNAccountInfo (NOLOCK) WHERE IsDefault=1 and ClientCode in (SELECT ClientCode FROM MNClientContact (NOLOCK) WHERE ContactNumber1 = '" + mobile + "')";
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(conStr))
                {
