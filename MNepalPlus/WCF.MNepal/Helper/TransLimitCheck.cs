...
{
    public class TransLimitCheck
    {
        public string LimitCheck(string mobile, string destmobile, string amount, string sc, string pin, string src)
        {
            ...
            amtInt32 = decimal.Parse(amount); // Int32.Parse(amount);
            ...
            if (customerNo != "0")
            {
                ...
                if (pin != "")
                {
                    ...
                    {
                        statusCode = "400";
                        message = "user blocked, contact administrator";
                    ...
                    if (validStatus == "Active")
                    {
                        ...
                        if ((hasKYC == "F") || ((hasKYC == "P") && (HasBankKYC == "F")) || ((hasKYC == "P") && (HasBankKYC == "P")))
                        {
                            ...
                            {
                                statusCode = "400";
                                message = "No need to fill KYC if you Link your Bank Account / Link your Bank Account and get your KYC filled"; // "Update your KYC details to get rid of restriction. ";
                                replyMessage.Response = message;
                                replyMessage.ResponseCode = HttpStatusCode.Unauthorized.ToString();
                                replyMessage.ResponseStatus(HttpStatusCode.Unauthorized, replyMessage.Response);
                            }
                        ...
                        else if ((hasKYC == "T") && (HasBankKYC == "T"))
                        {
                            ...
                            || (sc == "50") || (sc == "51") || (sc == "40") || (sc == "41"))
                            {
                                ...
                                if (dtableUserWalletLimit != null)
                                {
                                    ...
                                    totTxnAmt = decimal.Parse(totalAmount);
                                    totMonthlyTxnAmt = decimal.Parse(totalMonthlyTran);
                                    remMonthlyAmt = MonthlyLimit - totMonthlyTxnAmt;
                                    baln = decimal.Parse(balance);
                                }
                                else
                                {
                            ...
                            if ((sc == "10") || (sc == "11") || (sc == "33") || (sc == "34") || (sc == "35"))
                            {
                                    ...
                                    if ((todayDate >= sdt) && (DateTime.Today <= dt2))
                                    {
                                        if (LimitType == "L")
                                        {
                                            if (totIndvMonthlyAmt > IndvTransLimitMonthly)
                                            {
                                                ...
                                                decimal mthlimitRemain = IndvTransLimitMonthly - totIndvTxnMonthlyAmt;
                                                statusCode = "508";
                                            ...
                                            if (Convert.ToInt32(totalCount) > IndvTransCount)
                                            {
                                                if (totIndvDailyAmt > IndvTransLimitDaily)
                                                {
                                                    ...
                                                    decimal indvlimitRemain = IndvTransLimitDaily - totIndvTxnDailyAmt;
                                                    statusCode = "508";
                                ...
                                if (EDIndvTxn == "Dis")
                                {
                                    ...
                                    if (totMonthlyAmt > MonthlyLimit)
                                    {
                                        ...
                                        decimal mthlimitRemain = MonthlyLimit - totMonthlyTxnAmt;
                                    ...
                                    if (totAmt > DailyLimit)
                                    {
                                        ...
                                        //decimal dailyLimit = DailyLimit - totAmt;
                                        decimal dailyLimit = DailyLimit - totTxnAmt;
                                        message = "Daily Transaction amount limit reached. Remain daily limit: " + String.Format("{0:0.00}", dailyLimit);
                                        replyMessage.ResponseStatus(HttpStatusCode.InternalServerError, message);
                                    }
                                    if (Decimal.Parse(amount) > singleTransLimit)
                                    {
                ...
                {
                    statusCode = "400";
                    message = "Invalid PIN "; //+ errorpin;
                    replyMessage.Response = "Invalid PIN "; //+ errorpin;
                    replyMessage.ResponseCode = HttpStatusCode.Unauthorized.ToString();
                    replyMessage.ResponseStatus(HttpStatusCode.Unauthorized, replyMessage.Response);
                }
