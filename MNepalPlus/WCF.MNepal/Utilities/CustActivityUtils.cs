...
namespace WCF.MNepal.Utilities
{
    public class CustActivityUtils
    {
        ...
        public static string GetTransDailyAmt(string retRef)
        {
            var objGetTransDailyAmt = new CustActivityUserModel();
            return objGetTransDailyAmt.GetTransDailyAmt(retRef);
        }
        #endregion
    }
}