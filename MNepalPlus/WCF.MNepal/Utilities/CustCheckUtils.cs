...
namespace WCF.MNepal.Utilities
{
    public class CustCheckUtils
    {
        ...
        public static DataTable GetAgentStatusInfo(string cmobile)
        {
            var objModel = new CustCheckerUserModel();
            var objCustUserInfo = new MNClientExt
            {
            ...
            return objModel.GetAgentStatus(objCustUserInfo);
        }
        ...
        public static DataTable GetMerchantStatusInfo(string cmobile)
        {
            var objModel = new CustCheckerUserModel();
            var objCustUserInfo = new MNClientExt
            {
            ...
            return objModel.GetMerchantStatus(objCustUserInfo);
        }
