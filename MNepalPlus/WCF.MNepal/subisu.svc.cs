...
namespace WCF.MNepal
{
    ...
    public class subisu
    {
        ...
        public string executepayment(Stream input)
        {
            ...
            string Desc1New = "Thaili Pmt to Subisu for Cust ID:" + qs["account"] + "^^MNP^^Thaili Pmt to Subisu for Cust ID:" + qs["account"];

            string Desc1RevNew = "Rev-Thaili Pmt to Subisu for Cust ID:" + qs["account"] + "^^MNP^^Rev-Thaili Pmt to Subisu for Cust ID:" + qs["account"];
            ...
            try
            {
                ...
                if ((statusCode != "111") && (statusCode != "114") && (statusCode != "115") && (statusCode != "116") && (statusCode != "119") &&
                            ...
                            && (statusCode != "200") && (statusCode != "508") && (statusCode == "400") && (compResultResp == "101")
                            )
                {
                    ...
                    if (sc == "00")
                    {
                        transactionType = "SUbisu Txfr to W2W";
                    }
                    else
                    {
                        sc = "01";
                        transactionType = "Subisu Txfr to W2B"; //B2W
                    }
