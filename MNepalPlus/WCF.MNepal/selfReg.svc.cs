                                        ...
                                        if (response.StatusCode == HttpStatusCode.OK)
                                        {
                                            try
                                            {
                                                ...
                                                if ((UserName.Substring(0, 3) == "980") || (UserName.Substring(0, 3) == "981")) //FOR NCELL
                                                {
                                                    ...
                                                    //    + "977" + UserName + "&message=" + messagereply + "");
                                                    var contents = client.DownloadString(
                                                                    SMSNCELL + "977" + UserName + "&message=" + messagereply + "");
                                                }
                                                            ...
                                                            || (UserName.Substring(0, 3) == "986"))
                                                {
                                                    ...
                                                    var contents = client.DownloadString(
                                                                    SMSNTC + "977" + UserName + "&message=" + messagereply + "");
                                                }
                    ...
                    if (!statusCode.Equals("400"))
                    {
                        ...
                        else
                        {
                            ...
                            if (result == "Success")
                            {
                                ...
                                string Pin = SelfRegisterUtils.GeneratePin();
                                UserValidate selfuservalidate = new UserValidate(UserName, HashAlgo.Hash(Password), HashAlgo.Hash(Pin), userType.ToLower(),
