...
namespace MNepalProject.Controllers
{
    public class MNBankTablesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var banks = dataContext.Query<MNBankTable>("SELECT * FROM MNBankTable (NOLOCK)");
            return View(banks);
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            var dataContext = new PetaPoco.Database(MNepalDBConnectionStringProvider.GetConnection());
            MNBankTable bank = dataContext.Single<MNBankTable>("SELECT * FROM MNBankTable (NOLOCK) WHERE BankCode=@0", id);
