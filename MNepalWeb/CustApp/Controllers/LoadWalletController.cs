    ...
    public class LoadWalletController : Controller
    {
        ...
        public ActionResult EBanking()
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                int id = TraceIdGenerator.GetID() + 1;
                string stringid = (id).ToString();//this.GetID() + 1
                string traceID = stringid.PadLeft(12, '0');
                ViewBag.TraceID = traceID;
        ...
        public ActionResult EBanking(FormCollection collection)
        {
            ...
            try
            {
                ...
                string retoken = collection["__RequestVerificationToken"].ToString();
                ...
                else
                {
                    ...
                    Session["LOGGEDUSER_ID"] = clientCode;
                    Session["LOGGEDUSER_NAME"] = name;
        ...
        public ActionResult EBankingLink()
        {
            ...
            ViewBag.retrievalReference = retrievalReference;
        ...
        //MNFundTransfer _ft
        {
            ...
            string PREF = Request.Form["PREF"];
            string AMT1 = Request.Form["AMT1"];
            string AMOUNT = Request.Form["AMOUNT"];
            string BID = Request.Form["BID"];
            string FirstName = Request.Form["FirstName"];
            string LastName = Request.Form["LastName"];
            string CustRefType = Request.Form["CustRefType"];
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                var action = "ft.svc/loadwalletrequest";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                var content = new FormUrlEncodedContent(new[]{
                        new KeyValuePair<string, string>("BID", BID),
                        new KeyValuePair<string,string>("PREF",PREF),
                        new KeyValuePair<string, string>("AMOUNT",AMOUNT),
                        new KeyValuePair<string, string>("BankId", BankId),
                        new KeyValuePair<string,string>("AMT1",AMT1),
                        new KeyValuePair<string,string>("FirstName",FirstName),
                        new KeyValuePair<string, string>("LastName",LastName),
                        new KeyValuePair<string,string>("CustRefType",CustRefType),
                ...
                return Json(new { responseCode = "200", responseText = "" },
                        JsonRequestBehavior.AllowGet);
