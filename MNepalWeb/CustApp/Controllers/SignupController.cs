                            ...
                            if (collection.AllKeys.Any())
                            {
                                try
                                {
                                    ...
                                    if (results > 0)
                                    {
                                        ...
                                        //string Message = string.Format("Dear " + srInfo.FName + ",\n Your new T-Pin is " + srInfo.PIN + " thaili wallet and Password is " + srInfo.Password + " .\n Thank You -MNepal");
                                        string Message = string.Format("Dear " + srInfo.FName + ",\n You are now a Thaili Customer, your login Password is " + srInfo.Password + " and transaction T-PIN is " + srInfo.PIN + " .\n Thank You -NIBL Thaili");
