...
namespace CustApp.Utilities
{
    public class ProfileUtils
    {
        ...
        #region NEW CUSTOMER DETAIL PROFILE INFORMATION

        public static DataSet GetCusDetailProfileInfoDS(string clientCode)
        {
            var objUserModel = new LoginUserModels();
            var objUserInfo = new UserInfo
            {
        ...
        #region Check KYC
        public static DataTable CheckKYC(string UserName)
        {
            var objUserModel = new LoginUserModels();
            var objUserInfo = new UserInfo
            {
            ...
            return objUserModel.CheckKYC(objUserInfo);
        }
        #endregion
        ...
        public static DataTable BankAccountNumber(string UserName)
        {
            ...
            return objUserModel.GetBankAccNumber(objUserInfo);
        }
        #endregion

        #region GetBankBranchCode
        public static DataTable BankBranchCode(string UserName)
        {
            var objUserModel = new LoginUserModels();
            var objUserInfo = new UserInfo
            {
            ...
            return objUserModel.GetBankBranchCode(objUserInfo);
        }
        #endregion

        #region Get Bank Register Username
        public static DataTable BankRegisterName(string UserName)
        {
            var objUserModel = new LoginUserModels();
            var objUserInfo = new UserInfo
            {
            ...
            return objUserModel.GetBankRegisterName(objUserInfo);
        }
        #endregion
        ...
        public static DataTable EBankingClientCode(string Mobile)
        {
            ...
            return objUserModel.EBankingClientCode(objUserInfo);
        }
        #endregion

        //end ebanking clientcode

        #region Check IsFirstLogin
        public static DataTable IsFirstLogin(string clientCode)
        {
            var objUserModel = new LoginUserModels();
            var objUserInfo = new UserInfo
            {
            ...
            return objUserModel.IsFirstLogin(objUserInfo);
        }
        #endregion
    }
}