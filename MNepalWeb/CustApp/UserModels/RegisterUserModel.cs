    ...
    public class RegisterUserModel
    {
        ...
        public int AdminRegisterUserInfo(UserInfo objUserInfo)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNAdminRegistration]", sqlCon))
                    {
            ...
            try
            {
                using (sqlCon = new SqlConnection(DatabaseConnection.ConnectionStr()))
                {
                    ...
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNAgentRegKyc]", sqlCon))
                    {
                        ...
                        sqlCmd.Parameters.AddWithValue("@CountryCode", objUserInfo.Country);
                        ...
                        sqlCmd.Parameters.AddWithValue("@FatherInLaw", objUserInfo.FatherInlawName);
                        ...
                        sqlCmd.Parameters.AddWithValue("@PAddress", objUserInfo.PAddress);
                        ...
                        sqlCmd.Parameters.AddWithValue("@CAddress", objUserInfo.CAddress);
                        ...
                        //sqlCmd.Parameters.AddWithValue("@PassportPhoto", objUserInfo.Photo1);
                        //sqlCmd.Parameters.AddWithValue("@DocPictureFront", objUserInfo.Front);
                        //sqlCmd.Parameters.AddWithValue("@DocPictureBack", objUserInfo.Back);
        ...
        public int CustomerRegAppRegisterUserInfo(UserInfo objUserInfo)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNCustomerRegAppKyc]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public int CustomerSelfRegInfo(CustomerSRInfo objsrInfo)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNSelfRegistrationKYCWeb]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        ...
                        sqlCmd.Parameters.AddWithValue("@BSDateOfBirth", objsrInfo.BSDateOfBirth);
                        //sqlCmd.Parameters.AddWithValue("@DateADBS", objsrInfo.DateADBS);
                        ...
                        sqlCmd.Parameters.AddWithValue("@FatherInLaw", objsrInfo.FatherInlawName);
                        ...
                        sqlCmd.Parameters.AddWithValue("@BSCitizenIssueDate", objsrInfo.BSCitizenshipIssueDate);
                        ...
                        sqlCmd.Parameters.AddWithValue("@BSLicenseIssueDate", objsrInfo.BSLicenseIssueDate);
                        sqlCmd.Parameters.AddWithValue("@LicensePlaceOfIssue", objsrInfo.LicensePlaceOfIssue);
                        sqlCmd.Parameters.AddWithValue("@LicenseExpiryDate", objsrInfo.LicenseExpireDate);
                        sqlCmd.Parameters.AddWithValue("@BSLicenseExpiryDate", objsrInfo.BSLicenseExpireDate);
                        ...
                        sqlCmd.Parameters.AddWithValue("@PassportExpiryDate", objsrInfo.PassportExpireDate);
        ...
        #region Customer Quick Self Registration
        public int CustomerQuickSelfRegInfo(CustomerSRInfo objsrInfo)
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNQuickSelfWebReg]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        sqlCmd.Parameters.AddWithValue("@UserName", objsrInfo.UserName);
                        sqlCmd.Parameters.AddWithValue("@Password", HashAlgo.Hash(objsrInfo.Password));
                        sqlCmd.Parameters.AddWithValue("@PIN", HashAlgo.Hash(objsrInfo.PIN));
                        sqlCmd.Parameters.AddWithValue("@UserType", objsrInfo.UserType);
                        sqlCmd.Parameters.AddWithValue("@OTPCode", objsrInfo.OTPCode);
                        sqlCmd.Parameters.AddWithValue("@Source", objsrInfo.Source);
                        sqlCmd.Parameters.AddWithValue("@FName", objsrInfo.FName);
                        ...
                        sqlCmd.Parameters.AddWithValue("@LName", objsrInfo.LName);
                        sqlCmd.Parameters.AddWithValue("@mode", objsrInfo.Mode);
                        sqlCmd.Parameters.AddWithValue("@retrievalRef", objsrInfo.retrievalReference);
                        sqlCmd.Parameters.AddWithValue("@Remark", "Quick Register THAILI DIGITAL ACTYPE: ");
                        //sqlCmd.Parameters.AddWithValue("@Status", objsrInfo.Status);
                        //sqlCmd.Parameters.AddWithValue("@IsRejected", objsrInfo.IsRejected);
                        //sqlCmd.Parameters.AddWithValue("@BranchCode", objsrInfo.BranchCode);
        ...
        #region EBanking
        public int EBanking(CustomerSRInfo objsrInfo)
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNEBanking]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        //sqlCmd.Parameters.AddWithValue("@UserName", objsrInfo.UserName);
                        //sqlCmd.Parameters.AddWithValue("@Password", objsrInfo.Password);
                        ...
                        sqlCmd.Parameters.AddWithValue("@EBDate", objsrInfo.EBDate);
                        sqlCmd.Parameters.AddWithValue("@retrievalReference", objsrInfo.retrievalReference);
                        sqlCmd.Parameters.AddWithValue("@mode", objsrInfo.Mode);
