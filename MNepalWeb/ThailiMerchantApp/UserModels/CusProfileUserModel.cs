...
using ThailiMerchantApp.Utilities.SqlHelper;
    ...
    public class CusProfileUserModel
    {
        ...
        public static IEnumerable<MNFeatureMasterVM> GetMNFeature()
        {
            ...
            try
            {
                ...
                string Sql = "SELECT * FROM MNFeatureMaster (NOLOCK) WHERE CanFeatureFI = 'T' ";
        ...
        public static IEnumerable<MNCustProfile> GetMNCustProfile(string ProfileCode)
        {
            ...
            try
            {
                ...
                string Sql = @"SELECT * FROM dbo.MNCustProfile (NOLOCK) WHERE CustProfileCode=@CustProfileCode";
