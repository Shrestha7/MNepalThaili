...
namespace MNepalWeb.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public ActionResult getDistrictNameJson(string id)
        {
            if ((id != "") || (id != null))
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    dname = row["Name"].ToString();
                }
                return Json(new { id= dname }, JsonRequestBehavior.AllowGet);
            }
            else
                return View();
        }
        ...
        public async Task<ActionResult> Registration(FormCollection collection, UserInfo model)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                userInfo.PDistrictID = collection["PDistrictText"].ToString();
                ...
                userInfo.CDistrictID = collection["CDistrictText"].ToString();
                ...
                //}
                if (string.IsNullOrEmpty(collection["PProvinceText"]))
                {
                    ModelState.AddModelError("PProvinceText", "Please enter Province");
                }
                if (string.IsNullOrEmpty(collection["PDistrictText"]))
                {
                    ModelState.AddModelError("PDistrictText", "Please enter District");
                }
                ...
                //}
                if (string.IsNullOrEmpty(collection["CProvinceText"]))
                {
                    ModelState.AddModelError("CProvinceText", "*Please enter Province");
                }
                if (string.IsNullOrEmpty(collection["CDistrictText"]))
                {
                    ModelState.AddModelError("CDistrictText", "*Please enter District");
                }
        ...
        public async Task<ActionResult> Modification(string btnCommand, FormCollection collection, UserInfo model)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnCommand == "Submit")
                {
                    ...
                    string PProvince = collection["PProvinceText"].ToString();
                    string PDistrictID = collection["PDistrictText"].ToString();
                    ...
                    string CProvince = collection["CProvinceText"].ToString();
                    string CDistrictID = collection["CDistrictText"].ToString();
                    ...
                    mNClientKYC.DateOfBirth = DateTime.ParseExact(userInfoModify.DOB, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                    mNClientKYC.BSDateOfBirth = userInfoModify.BSDateOfBirth;

                    mNClientKYC.Nationality = userInfoModify.Nationality;
                    mNClientKYC.CountryCode = userInfoModify.Country;
                    ...
                    mNClientKYC.CitizenIssueDate = DateTime.ParseExact(userInfoModify.CitizenshipIssueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                    ...
                    mNClientKYC.LicenseIssueDate = DateTime.ParseExact(userInfoModify.LicenseIssueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                    mNClientKYC.BSLicenseIssueDate = userInfoModify.BSLicenseIssueDate;
                    mNClientKYC.LicenseExpiryDate = DateTime.ParseExact(userInfoModify.LicenseExpireDate, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                    ...
                    mNClientKYC.PassportIssueDate = DateTime.ParseExact(userInfoModify.PassportIssueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                    mNClientKYC.PassportExpiryDate = DateTime.ParseExact(userInfoModify.PassportExpireDate, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                    ...
                    if (dtableUserInfo != null && dtableUserInfo.Rows.Count > 0)
                    {
                        ...
                        regobj.MotherName = dtUserKYC.Rows[0]["MothersName"].ToString();
                        regobj.GrandFatherName = dtUserKYC.Rows[0]["GFathersName"].ToString();
                        regobj.DateOfBirth = dtUserKYC.Rows[0]["DateOfBirth"].ToString();
                        regobj.DateOfBirth = DateTime.Parse(regobj.DateOfBirth.Trim()).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                        regobj.BSDateOfBirth = dtUserKYC.Rows[0]["BSDateOfBirth"].ToString();
                        ...
                        regobj.CitizenshipIssueDate = dtUserKYC.Rows[0]["CitizenIssueDate"].ToString();
                        ...
                        regobj.License = dtUserKYC.Rows[0]["LicenseNo"].ToString();
                        regobj.LicenseIssueDate = dtUserKYC.Rows[0]["LicenseIssueDate"].ToString();
                        regobj.LicenseIssueDate = DateTime.Parse(regobj.LicenseIssueDate.Trim()).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                        regobj.BSLicenseIssueDate = dtUserKYC.Rows[0]["BSLicenseIssueDate"].ToString();
                        regobj.LicenseExpireDate = dtUserKYC.Rows[0]["LicenseExpiryDate"].ToString();
                        regobj.LicenseExpireDate = DateTime.Parse(regobj.LicenseExpireDate.Trim()).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                        regobj.BSLicenseExpireDate = dtUserKYC.Rows[0]["BSLicenseExpiryDate"].ToString();
                        regobj.LicensePlaceOfIssue = dtUserKYC.Rows[0]["LicensePlaceOfIssue"].ToString();
                        ...
                        regobj.Passport = dtUserKYC.Rows[0]["PassportNo"].ToString();
                        regobj.PassportIssueDate = dtUserKYC.Rows[0]["PassportIssueDate"].ToString();
                        regobj.PassportIssueDate = DateTime.Parse(regobj.PassportIssueDate.Trim()).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                        regobj.PassportExpireDate = dtUserKYC.Rows[0]["PassportExpiryDate"].ToString();
                        regobj.PassportExpireDate = DateTime.Parse(regobj.PassportExpireDate.Trim()).ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
                        ...
                        omnClientKYC.CountryCode = regobj.Country;
            ...
            try
            {
                ...
                if (ActionClick == "Approve")
                {
                    ...
                    if (info.Status == "PINR")
                    {
                        ...
                        Mode = "PIN";
                        Message = string.Format("Dear {0},\n Your new T-Pin is {1}.\n Thank You -NIBL Thaili", info.Name.Split()[0], info.PIN);
                    ...
                    else if (info.Status == "PASR")
                    {
                        ...
                        Mode = "PASS";
                        Message = string.Format("Dear {0},\n Your new Password is {1}.\n Thank You -NIBL Thaili", info.Name.Split()[0], info.Password);
                    ...
                    else if (info.Status == "PPR")
                    {
                        ...
                        info.Password = CustomerUtils.GeneratePassword();
                        Mode = "BOTH";
                        Message = string.Format("Dear {0},\n Your new T-Pin is {1} and Password is {2}.\n Thank You -NIBL Thaili", info.Name.Split()[0], info.PIN, info.Password);
        ...
        public ActionResult DeleteUser(string btnCommand, FormCollection collection)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnCommand == "Submit")
                {
                    ...
                    string BlockRemarks = collection["BlockRemarks"].ToString();
                    ...
                    if (OldStatus != newStatus)
                    {
                        if (newStatus != "")
                        {
                            bool isUpdated = DeleteUtils.ChangeUserInfo(cClientCode, newStatus, AdminBranchCode, AdminUserName,BlockRemarks);
                            displayMessage = isUpdated
            ...
            try
            {
                ...
                if (dtableUserInfo != null && dtableUserInfo.Rows.Count > 0)
                {
                    ...
                    if (info.Status == "Blocked")
                    {
                        ...
                        /*Sms Message for unblock message */

                        Message = "Dear" + " " + FirstName + ",\n";
                        Message += "Your account 98******** for user has been unblocked, for detail please contact administrator"
                            + "." + "\n" + "Thank You";
                        Message += "-NIBL Thaili";
                    ...
                    else
                    {
                        ...
                        /*Sms Message for block message */
                        
                        Message = "Dear"+" "+ FirstName + ",\n";
                        Message += "Your account 98********  for user has been blocked, for detail please contact administrator"
                            + "." + "\n" + "Thank You";
                        Message += "-NIBL Thaili";
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnApprove.ToUpper() == "REJECT")
                {
                    ...
                    if (ret == 100)
                    {
                        ...
                        DataTable dtableUserInfo = DSet.Tables["dtUserInfo"];
                        model.Name = dtableUserInfo.Rows[0]["Name"].ToString();
                ...
                else if (btnApprove.ToUpper() == "APPROVE")
                {
                    ...
                    if (ret == 100)
                    {
                        ...
                        userInfo.PIN = CustomerUtils.GeneratePin();
                        bool pinChange = PinUtils.ResetPin(userInfo);
                        ...
                        string Message = string.Format("Dear {0},\n You are now a Thaili Customer, your login password is {1} and transaction T-PIN is {2}.\n Thank You - NIBL Thaili", model.Name.Split()[0], userInfo.Password, userInfo.PIN);
                        //string Message = string.Format("Dear {0},\n Your new T-Pin is {1} and Password is {2}.\n Thank You -NIBL Thaili", model.Name.Split()[0], userInfo.PIN, userInfo.Password);
        ...
        public ActionResult ViewModifyDetail(string id)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (dtableUserInfo != null && dtableUserInfo.Rows.Count > 0)
                {
                    ...
                    regobj.Nationality = dtUserKYC.Rows[0]["Nationality"].ToString();
                    //regobj.DOB = DateTime.Parse(dtUserKYC.Rows[0]["DateOfBirth"].ToString()).ToString("dd/MM/yyyy");
                    regobj.DOB = dtUserKYC.Rows[0]["DateOfBirth"].ToString().Split()[0];
                    ...
                    regobj.Citizenship = dtUserKYC.Rows[0]["CitizenshipNo"].ToString();
                    //regobj.CitizenshipIssueDate = DateTime.Parse(dtUserKYC.Rows[0]["CitizenIssueDate"].ToString()).ToString("dd/MM/yyyy");
                    regobj.CitizenshipIssueDate = dtUserKYC.Rows[0]["CitizenIssueDate"].ToString().Split()[0];
                    ...
                    regobj.PassportPlaceOfIssue = dtUserKYC.Rows[0]["PassportPlaceOfIssue"].ToString();
                    //regobj.PassportIssueDate = DateTime.Parse(dtUserKYC.Rows[0]["PassportIssueDate"].ToString()).ToString("dd/MM/yyyy");
                    regobj.PassportIssueDate = dtUserKYC.Rows[0]["CitizenIssueDate"].ToString().Split()[0];
                    ...
                    regobj.LicensePlaceOfIssue = dtUserKYC.Rows[0]["LicensePlaceOfIssue"].ToString();
                    //regobj.LicenseIssueDate = DateTime.Parse(dtUserKYC.Rows[0]["LicenseIssueDate"].ToString()).ToString("dd/MM/yyyy");
                    regobj.LicenseIssueDate = dtUserKYC.Rows[0]["CitizenIssueDate"].ToString().Split()[0];
                    regobj.LicenseIssueDate = DateTime.Parse(regobj.LicenseIssueDate.Trim()).ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
                    regobj.BSLicenseIssueDate = dtUserKYC.Rows[0]["BSLicenseIssueDate"].ToString();
                    //regobj.LicenseExpireDate = DateTime.Parse(dtUserKYC.Rows[0]["LicenseExpiryDate"].ToString()).ToString("dd/MM/yyyy");
                    regobj.LicenseExpireDate = dtUserKYC.Rows[0]["CitizenIssueDate"].ToString().Split()[0];
        ...
        public async Task<ActionResult> ModifyRejected(string btnCommand, FormCollection collection, UserInfo model)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnCommand == "Submit")
                {
                    ...
                    string cCDistrictID = collection["CDistrictText"].ToString();
                    ...
                    string cPDistrictID = collection["PDistrictText"].ToString();
                    string cPProvince = collection["PProvinceText"].ToString();

                    string cDOB = collection["DOB"].ToString();
                    //string cDOB = ( DateTime.ParseExact(collection["DOB"], "dd/MM/yyyy", CultureInfo.InvariantCulture)
            ...
            if (TempData["userType"] != null&& checkRole)
            {
                ...
                if (Key == "Mobile")
                {
                    if (!string.IsNullOrEmpty(Value))
                    {
                        ...
                        {
                            //row = dtblCus.AsEnumerable().Where(r => r.Field<string>("MobileNumber") == Value).Where(r => r.Field<string>("UserBranchCode") == UserBranchCode);
                            row = dtblCus.AsEnumerable().Where(r => r.Field<string>("MobileNumber") == Value).Where(r => r.Field<string>("VerifiedBranch") == UserBranchCode);
                        }
                        //row = dtblCus.AsEnumerable().Where(r => r.Field<string>("MobileNumber") == Value).Where(r => r.Field<string>("UserBranchCode") == UserBranchCode);
                        if (row.Any())
                            dtblUnapproveCus = row.CopyToDataTable();
                ...
                else
                {
                    ...
                    {
                        //row = dtblCus.AsEnumerable().Where(r => r.Field<string>("UserBranchCode") == UserBranchCode);
                        row = dtblCus.AsEnumerable().Where(r => r.Field<string>("VerifiedBranch") == UserBranchCode);
                        if (row.Any())
                            dtblUnapproveCus = row.CopyToDataTable();
                    }
                    else
                ...
                if (dtblUnapproveCus.Rows.Count > 0)
                {
                    ...
                    userInfo.VerifiedBy = dtblUnapproveCus.Rows[0]["VerifiedBy"].ToString();
                    ...
                    {
                        DateTime verifiedDate = DateTime.Parse(VerifiedDate);
                        userInfo.VerifiedDate = verifiedDate.ToString("dd/MM/yyyy");
                    }
        ...
        [HttpPost]
        public ActionResult BankLinkApprove(UserInfo model, string btnApprove, CustomerSRInfo info, FormCollection collection, string Remarks)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnApprove.ToUpper() == "REJECT")
                {
                    ...
                    {
                        userInfoBankLinkApproval.Remarks = collection["OthersRemarks"].ToString();
                    }
                    else
                    {
                    ...
                    if (ret == 100)
                    {
                        displayMessage = "Customer " + userInfoBankLinkApproval.Name + "'s bank link has been Rejected.";
        ...
        public ActionResult ViewBankLinkDetail(string id)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (dtblUnapproveCus.Rows.Count > 0)
                {
                    ...
                    userInfo.AcNumber = dtblUnapproveCus.Rows[0]["AccountNumber"].ToString();
                    string DOB = dtblUnapproveCus.Rows[0]["DateOfBirth"].ToString();
                    userInfo.IsApproved= dtblUnapproveCus.Rows[0]["isVerified"].ToString();
                    DateTime dob = DateTime.Parse(DOB);                    
                    userInfo.DOB = dob.ToString("dd/MM/yyyy");
                    ...
                    ViewBag.AcNumber = userInfo.AcNumber;
                    ViewBag.DOB = userInfo.DOB;
                    if (userInfo.IsApproved.Equals("T"))
                    {
                        ViewBag.IsApproved = "Verified";
                    }
                    else
                    ViewBag.IsApproved = "";
                ...
                DataTable dtableGetUserInfo = ProfileUtils.GetCustomerName(ViewBag.ContactNumber1);
                DataTable UserInfomation = ProfileUtils.GetUserProfileInfo(userInfo.ClientCode);
                if (dtableGetUserInfo != null && dtableGetUserInfo.Rows.Count > 0)
                {
                    ...
                    ViewBag.FullName = userInfo.FName + " " + userInfo.MName + " " + userInfo.LName;
                    if (userInfo.FName.Equals("") || userInfo.FName.Equals(null) || userInfo.LName.Equals("") || userInfo.LName.Equals(null))
                    {
                        ViewBag.FullName = UserInfomation.Rows[0]["Name"].ToString();
        ...
        // GET: Customer/ApproveList
        [HttpGet]
        public ActionResult BankLinkVerifyList(string Key, string Value)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null /*&& checkRole*/)
            {
                ...
                userInfo.ClientCode = clientCode;
                DataTable dtblUnapproveCus = new DataTable();
                DataTable dtblCus = CustomerUtils.GetVerifyAccNo(userInfo);
                ...
                if (dtblUnapproveCus.Rows.Count > 0)
                {
                    ...
                    userInfo.Name = dtblUnapproveCus.Rows[0]["Name"].ToString();
                    userInfo.AcNumber = dtblUnapproveCus.Rows[0]["AccountNumber"].ToString();
                    string HasKYC = dtblUnapproveCus.Rows[0]["HasKYC"].ToString();
                    if (HasKYC == "T")
                    {
                        userInfo.KYCStatus = "True";
                    }
                    else if (HasKYC == "P")
                    {
                    ...
                    ViewBag.AcNumber = userInfo.AcNumber;
                    ViewBag.DOB = userInfo.DOB;
                    ViewBag.requestedDate = userInfo.requestedDate;
                    ViewBag.KYCStatus = userInfo.KYCStatus;
                    ViewBag.SearchValue = Value;
                    ViewBag.COC = COC; //test
                    custUnApproveObj.Add(userInfo);
        ...
        [HttpPost]
        public ActionResult BankLinkVerify(UserInfo model, string btnApprove, CustomerSRInfo info, FormCollection collection, string Remarks)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            string userType = (string)Session["LOGGED_USERTYPE"];
            string bankCode = (string)Session["BankCode"];
            string UserBranch = (string)Session["UserBranch"];

            //bool COC = (bool)Session["COC"];
            //TempData["COC"] = COC;

            TempData["userType"] = userType;
            info.VerifiedBy = userName;
            info.VerifiedBranch= UserBranch;
            ...
            if (TempData["userType"] != null)
            {
                ...
                //{
                    //row = dtblCus.AsEnumerable().Where(r => r.Field<string>("UserBranchCode") == UserBranchCode);
                    row = dtblCus.AsEnumerable().Where(r => r.Field<string>("MobileNumber") == collection["UserName"].ToString() && r.Field<string>("AccountNumber") == collection["txtAccountNo"].ToString());
                    if (row.Any())
                        dtblUnapproveCus = row.CopyToDataTable();
                //}
                //else
                ...
                if (btnApprove.ToUpper() == "REJECT")
                {
                    ...
                    return RedirectToAction("BankLinkVerifyList");

                }
                else if (btnApprove.ToUpper() == "VERIFY")
                {
                    userInfoBankLinkApproval.VerifiedBy = info.VerifiedBy;
                    userInfoBankLinkApproval.VerifiedBranch = info.VerifiedBranch;
                    LinkBankCheck(userInfoBankLinkApproval);
                    displayMessage = "Customer " + userInfoBankLinkApproval.Name + "'s bank link has been verified.";
                    messageClass = CssSetting.SuccessMessageClass;
                    /*
                    userInfoBankLinkApproval.ApprovedBy = userName;
                    ///for date
        ...
        public ActionResult ViewBankLinkVerifyDetail(string id)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
        ...
        #region Update Remarks and isVerified in MNLinkBankTable
        public void LinkBankCheck(UserInfo userInfoBankLinkApproval)
        {
                string Query_Update = "UPDATE MNLinkBankTable SET isVerified='T', VerifiedBy='"+userInfoBankLinkApproval.VerifiedBy+ "', VerifiedBranch='" + userInfoBankLinkApproval.VerifiedBranch + "' WHERE ClientCode='" + userInfoBankLinkApproval.ClientCode + "' AND MobileNumber='" +userInfoBankLinkApproval.ContactNumber1 + "'";
                
                DataTable dt = new DataTable();
                dt = objdal.MyMethod(Query_Update);

                string Query_Update1 = "UPDATE MNBankLinkDetails SET isVerified='T', VerifiedBy='" + userInfoBankLinkApproval.VerifiedBy + "', VerifiedBranch='" + userInfoBankLinkApproval.VerifiedBranch + "', VerifiedDate = GETDATE() WHERE ClientCode='" + userInfoBankLinkApproval.ClientCode + "' AND MobileNumber='" + userInfoBankLinkApproval.ContactNumber1 + "'";
                DataTable dt1 = new DataTable();
                dt1 = objdal.MyMethod(Query_Update1);
        ...
        #region Verify BankLink KYC Reset

        public ActionResult BankLinkedList()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
        ...
        public ActionResult CustomerDetails(string SearchCol, string txtMobileNo)

        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                {
                    DataTable dtableCustomerStatusByMobileNo = CustomerUtils.CheckBankLink(userInfo.ContactNumber1);
                    if (dtableCustomerStatusByMobileNo != null && dtableCustomerStatusByMobileNo.Rows.Count > 0)
                    {
                        UserInfo regobj = new UserInfo
                        {
                            ...
                            ApprovedBy = dtableCustomerStatusByMobileNo.Rows[0]["ApprovedBy"].ToString(),
                            CreatedBy = dtableCustomerStatusByMobileNo.Rows[0]["CreatedBy"].ToString(),
                            UserName = dtableCustomerStatusByMobileNo.Rows[0]["UserName"].ToString(),
                            BankAccountNumber = dtableCustomerStatusByMobileNo.Rows[0]["BankAccountNumber"].ToString(),
        ...
        public ActionResult BankLinkReset(string id)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                UserInfo userInfo = new UserInfo();
                userInfo.ClientCode = id;
                DataTable dtblCus = CustomerUtils.GetUserProfileInfoDS(id);
                DataTable dtblUnapproveCus = new DataTable();
                dtblUnapproveCus = dtblCus;
                ...
                {
                    userInfo.ClientCode = dtblUnapproveCus.Rows[0]["ClientCode"].ToString();
                    userInfo.ContactNumber1 = dtblUnapproveCus.Rows[0]["UserName"].ToString();
                    userInfo.Name = dtblUnapproveCus.Rows[0]["Name"].ToString();
                    userInfo.AcNumber = dtblUnapproveCus.Rows[0]["BankAccountNumber"].ToString();
        ...
        [HttpPost]
        public ActionResult BankLinkReset(UserInfo model, string btnApprove, CustomerSRInfo info, FormCollection collection, string Remarks)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnApprove.ToUpper() == "RESET BANKLINK")
                {
                    userInfoBankLinkApproval.ClientCode = info.ClientCode;
                    userInfoBankLinkApproval.UserName = info.UserName;
                    userInfoBankLinkApproval.ModifyingAdmin = userName;
                    userInfoBankLinkApproval.ModifyingBranch = UserBranch;
                    userInfoBankLinkApproval.Remarks = info.Remarks;
                    
                    int ret = CustomerUtils.VerifyReset(userInfoBankLinkApproval);
                    if (ret == 100)                     
                    {

                        displayMessage = "Customer " + model.Name + "BankLink Status Reset has been successfully updated.";
                        messageClass = CssSetting.SuccessMessageClass;

                    }
                    else
                    {
                        displayMessage = "Error while reseting Customer " + model.Name;
                        messageClass = CssSetting.FailedMessageClass;
                    }
                    ...
                    return RedirectToAction("BankLinkedList");
                }
        ...
        #region Approve BankLink KYC Reset       
        public ActionResult BankLinkResetList(string Key, string Value)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null && checkRole)
            {
                ...
                List<UserInfo> custUnApproveObj = new List<UserInfo>();
                UserInfo userInfo = new UserInfo();
                DataTable dtCustomerInfoApprove = new DataTable();
                DataTable dtblCus = CustomerUtils.GetBanklinkCustReset("user");
                ...
                if (Key == "Mobile")
                {
                    if (!string.IsNullOrEmpty(Value))
                    {
                        ...
                        {
                            row = dtblCus.AsEnumerable().Where(r => r.Field<string>("MobileNumber") == Value).Where(r => r.Field<string>("ResetBranch") == UserBranchCode);
                        }
                        if (row.Any())
                            dtCustomerInfoApprove = row.CopyToDataTable();
                    }
                ...
                else
                {
                    ...
                    if (COC == false)
                    {
                        row = dtblCus.AsEnumerable().Where(r => r.Field<string>("ResetBranch") == UserBranchCode);
                        if (row.Any())
                            dtCustomerInfoApprove = row.CopyToDataTable();
                    }
                    else
                    {
                        dtCustomerInfoApprove = dtblCus;
                    }
                }
                
                if (dtCustomerInfoApprove.Rows.Count > 0)
                {
                    userInfo.ClientCode = dtCustomerInfoApprove.Rows[0]["ClientCode"].ToString();
                    userInfo.ContactNumber1 = dtCustomerInfoApprove.Rows[0]["MobileNumber"].ToString();
                    userInfo.Name = dtCustomerInfoApprove.Rows[0]["Name"].ToString();
                    userInfo.BankAccountNumber = dtCustomerInfoApprove.Rows[0]["BankAccountNumber"].ToString();
                    userInfo.DateOfBirth = dtCustomerInfoApprove.Rows[0]["DateOfBirth"].ToString();
                    userInfo.RejectedBy = dtCustomerInfoApprove.Rows[0]["ResetBy"].ToString();
                    ViewBag.CustClientCode = userInfo.ClientCode;
                    ViewBag.ContactNumber1 = userInfo.ContactNumber1;
                    ViewBag.CName = userInfo.Name;
                    ViewBag.Address = userInfo.Address;
                ...
                var selfregistred = dtCustomerInfoApprove.AsEnumerable().Where(r => r.Field<string>("SelfRegistered") == "T");
                var agentregistred = dtCustomerInfoApprove.AsEnumerable().Where(r => r.Field<string>("AgentRegistered") == "T");
        ...
        public ActionResult ViewResetCustDetail(string id)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
        ...
        [HttpPost]
        public ActionResult ViewResetCustDetail(UserInfo model, string btnApprove, FormCollection collection, string Remarks)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                UserInfo userInfoApproval = new UserInfo();
                DataTable dtblRegistration = CustomerUtils.GetUserProfileInfoDS(model.ClientCode);
                if (dtblRegistration != null && dtblRegistration.Rows.Count > 0)
                {
                    userInfoApproval.FName = dtblRegistration.Rows[0]["FName"].ToString();
                }
                userInfoApproval.ClientCode = model.ClientCode;
                userInfoApproval.ApprovedBy = userName;
                userInfoApproval.UserType = "User";
                userInfoApproval.UserName = userName;
                userInfoApproval.BranchCode = UserBranchCode;
                userInfoApproval.Remarks = Remarks;
                if (btnApprove.ToUpper() == "REJECT BANKLINK RESET")
                {

                    int ret = CustomerUtils.RejectBankLinkReset(userInfoApproval);
                    if (ret == 100)
                    {

                        displayMessage = "Customer " + model.Name + " BankLink Reset Status has been Rejected.";
                        messageClass = CssSetting.SuccessMessageClass;
                    ...
                    return RedirectToAction("BankLinkResetList");

                }
                else
                if (btnApprove.ToUpper() == "APPROVE BANKLINK RESET")
                {
                    userInfoApproval.ApprovedBy = userName;
                    int ret = CustomerUtils.BLResetApprove(userInfoApproval);
                    if (ret == 100)
                    {


                        displayMessage = "BankLink Reset Status for user " + userInfoApproval.FName + " has successfully been approved.";


                        //SMS
                        SMSUtils SMS = new SMSUtils();

                        string Message = string.Format("Dear {0},\n Your BankLink has been Reset. Please Link your Bank Account and submit again. \n Thank You -NIBL Thaili", userInfoApproval.FName);
