...
namespace MNSuperadmin.UserModels
{
    public class CustomerUserModel
    {
        ...
        #region new KYC Reset Verification
        internal DataTable GetCustApproveKYCDetailInfo(UserInfo objUserInfo)//CustApproveInfo
        {
            ...
            {
                database = DatabaseConnection.GetDatabase();
                using (var command = database.GetStoredProcCommand("[s_MNCustomerKYCReset]")) //
                {
                    database.AddInParameter(command, "@ClientCode", DbType.String, objUserInfo.ClientCode);
                    database.AddInParameter(command, "@ApprovedBy", DbType.String, objUserInfo.ApprovedBy);
                    database.AddInParameter(command, "@ResetBranch", DbType.String, objUserInfo.BranchCode);
        ...
        internal int CustInfoApprove(UserInfo objUserInfo)//KYC Reset Approve
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNCustomerKYCReset]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
