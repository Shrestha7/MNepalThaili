                ...
                if (btnApprove.ToUpper() == "APPROVE")
                {
                    ...
                    if (ret == 1)
                    {
                        ...
                        if (userInfo.EmailAddress != "" && userInfo.EmailAddress != string.Empty)
                        {
                            ...
                            MailSubject += "<br/>-NIBL Thaili </span><br/>";
                            MailSubject += @"<br/>Note: This is confidential mail, Please do not share with other. Your credential purpose is for NIBL Thaili Administration Console only.<br/>";
                            MailSubject += "<hr/>";
                            ...
                            string Message = string.Format("Dear " + userInfo.Name + ",\n You are now a Thaili Merchant, your login password is " + userInfo.Password + " and transaction T-PIN is " + userInfo.PIN + ".\n Thank You -NIBL Thaili");
        ...
        public ActionResult PinReset(string btnCommand, FormCollection collection)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnCommand == "Reset")
                {
                    ...
                    //{
                    //    SMSUtils SMS = new SMSUtils();
                    //    string Message = string.Format("Dear {0},\n Your new T-Pin is {1}.\n Thank You -NIBL Thaili",userInfo.Name,userInfo.PIN);
            ...
            try
            {
                ...
                if (ActionClick == "Approve")
                {
                    ...
                    if (info.Status == "PINR")
                    {
                        ...
                        Mode = "PIN";
                        Message = string.Format("Dear {0},\n Your new T-Pin is {1}.\n Thank You -NIBL Thaili", info.Name, info.PIN);
                    ...
                    else if (info.Status == "PASR")
                    {
                        ...
                        Mode = "PASS";
                        Message = string.Format("Dear {0},\n Your new Password is {1}.\n Thank You -NIBL Thaili", info.Name, info.Password);
                    ...
                    else if (info.Status == "PPR")
                    {
                        ...
                        info.Password = CustomerUtils.GeneratePassword();
                        Mode = "BOTH";
                        Message = string.Format("Dear {0},\n Your new T-Pin is {1} and Password is {2}.\n Thank You -NIBL Thaili", info.Name, info.PIN, info.Password);
