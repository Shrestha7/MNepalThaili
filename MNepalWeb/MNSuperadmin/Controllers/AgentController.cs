                ...
                if (btnApprove.ToUpper() == "APPROVE")
                {
                    ...
                    if (ret == 1)
                    {
                        ...
                        if (userInfo.EmailAddress != "" && userInfo.EmailAddress != string.Empty)
                        {
                            ...
                            MailSubject += "New Thaili agent is created for you at Nepal Investment Bank Ltd. Mobile Banking and you have been issued with a new temporary password. ";
                            MailSubject += "NIBL Thaili.<br/>";
                            ...
                            string Message = string.Format("Dear " + userInfo.FName + ",\n You are now a Thaili Agent, your login password is "+ userInfo.Password + " and transaction T-PIN is "+userInfo.PIN+".\n Thank You -NIBL Thaili");
            ...
            try
            {
                ...
                if (ActionClick == "Approve")
                {
                    ...
                    if (info.Status == "PINR")
                    {
                        ...
                        Mode = "PIN";
                        Message = string.Format("Dear {0},\n Your new T-Pin is {1}.\n Thank You -NIBL Thaili", info.FName, info.PIN);
                    ...
                    else if (info.Status == "PASR")
                    {
                        ...
                        Mode = "PASS";
                        Message = string.Format("Dear {0},\n Your new Password is {1}.\n Thank You -NIBL Thaili", info.FName, info.Password);
                    ...
                    else if (info.Status == "PPR")
                    {
                        ...
                        info.Password = CustomerUtils.GeneratePassword();
                        Mode = "BOTH";
                        Message = string.Format("Dear {0},\n Your new T-Pin is {1} and Password is {2}.\n Thank You -NIBL Thaili", info.FName, info.PIN, info.Password);
