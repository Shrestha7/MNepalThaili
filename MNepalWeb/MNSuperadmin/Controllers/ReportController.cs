...
namespace MNSuperadmin.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        public ContentResult EBankingCashLoadTable(DataTableAjaxPostModel model, string StartDate, string EndDate, string SourceMobileNo, string change, string ToExcel)
        {
            if (!Request.IsAjaxRequest())
            {
                Response.Write("Invalid Execution");
