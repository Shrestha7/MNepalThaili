...
namespace MNSuperadmin.Utilities
{
    public static class CustomerUtils
    {
        ...
        internal static DataTable GetApprovedCustKYC(string ContactNumber1)
        {
            var objUserModel = new CustomerUserModel();
            var objUserInfo = new UserInfo
            {
                UserName = ContactNumber1,
                Mode = "GACI" // --APPROVE LIST FOR CUSTOMER
            };
            return objUserModel.GetCustApproveKYCDetailInfo(objUserInfo);
        }
        #endregion

        internal static int VerifyKYCReset(this UserInfo member)
        {
            var objUserModel = new CustomerUserModel();
            var objUserInfo = new UserInfo
            {
        ...
        #region get CustomerKYCDetail
        internal static DataTable GetVerifiedCustKYC(string UserType)
        {
            var objUserModel = new CustomerUserModel();
            var objUserInfo = new UserInfo
            {
                UserType = UserType,
                Mode = "GVC" // --APPROVE LIST FOR CUSTOMER
            };
            return objUserModel.GetCustApproveKYCDetailInfo(objUserInfo);
        }
        #endregion
        ...
        internal static int RejectKYCReset(this UserInfo member)
        {
            var objUserModel = new CustomerUserModel();
            var objUserInfo = new UserInfo
            {
                ...
                BranchCode = member.BranchCode,
                Remarks = member.Remarks,
                Mode = "KYCRR" //KYC Reset Reject
            };
            return objUserModel.CustInfoApprove(objUserInfo);
        }

        internal static int KYCResetApprove(this UserInfo member)
        {
            var objUserModel = new CustomerUserModel();
            var objUserInfo = new UserInfo
            {
