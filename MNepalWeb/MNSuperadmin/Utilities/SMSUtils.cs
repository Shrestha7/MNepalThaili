...
namespace MNSuperadmin.Utilities
{
    public class SMSUtils
    {
        public void SendSMS(string Message,string mobile)
        {
            ...
            string SMS = System.Web.Configuration.WebConfigurationManager.AppSettings["MNepalSMSServerUrl"];
            ...
            if ((mobile.Substring(0, 3) == "980") || (mobile.Substring(0, 3) == "981")) //FOR NCELL
            {
                ...
                var content = client.DownloadString(SMS + "977" + mobile + "&message=" + messagereply + "");
            }
