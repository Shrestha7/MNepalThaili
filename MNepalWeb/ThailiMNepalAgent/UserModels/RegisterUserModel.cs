...
namespace ThailiMNepalAgent.UserModels
{
    public class RegisterUserModel
    {
        ...
        //        {
        //            sqlCon.Open();
        //            using (SqlCommand sqlCmd = new SqlCommand("[s_MNSelfWebRegistration]", sqlCon))
        //            {
        //                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public int CustomerSelfRegInfo(CustomerSRInfo objsrInfo)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNSelfWebRegistrationByAgent]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        ...
                        sqlCmd.Parameters.AddWithValue("@Remark", "Register By Agent THAILI DIGITAL ACTYPE: ");
                        sqlCmd.Parameters.AddWithValue("@mode", objsrInfo.Mode);
