...
namespace ThailiMNepalAgent.Controllers
{
    ...
    public class SignupByAgentController : Controller
    {
        ...
        public ActionResult Index(FormCollection collection)
        {
            ...
            try
            {
                if (!IsValidUserName(userName))
                {
                    ...
                    {
                        //FOR NCELL
                        var contents = client.DownloadString(SMSKey
                        + "977" + mobile + "&message=" + messagereply + "");
                    }
        ...
        {
            string provincestring = "SELECT * FROM MNProvince (NOLOCK) WHERE ProvinceID='" + id + "'";
                                ...
                                try
                                {
                                    ...
                                    if (results > 0)
                                    {
                                       ...
                                       // string Message = string.Format("Dear " + srInfo.FName + ",\n Your new T-Pin is " + srInfo.PIN + " and Password is " + srInfo.Password + " .\n Thank You -NIBL Thaili");
                                        string Message = string.Format("Dear " + srInfo.FName + ",\n You are now a Thaili Customer, your login password is " + srInfo.Password + " and transaction T-PIN is " + srInfo.PIN + " . Thank You -  NIBL Thaili");
                                        ...
                                        int ret = RegisterUtils.InsertResponseQuickSelfReg(srInfo.UserName, tid, "200", "New Registration By Agent");

                                        //return RedirectToAction("CustomerKYCFinish");
                                        return RedirectToAction("../SignupByAgent/CustomerKYCFinish");
