            ...
            try
            {
                    ...
                    else if ((userName != string.Empty) && (passWord != string.Empty))
                    {
                        ...
                        if (Session["ID"] == null)
                        {
                          ...
                          DataTable dtableMobileNo = RegisterUtils.GetCheckAgentNo(userName);
                            ...
                            if (Status == "Blocked" && IsApproved == "Approve")
                            {
                                ...
                                displayMessage = "Agent blocked, contact administrator";
                            }
                            ...
                            else
                            {
                                ...
                                if (dtableBlockUserWrongPwd != null && dtableBlockUserWrongPwd.Rows.Count > 0)
                                {
                                    ...
                                    if (dtableUser != null && dtableUser.Rows.Count > 0)
                                    {
                                        ...
                                        string ipaddress; string localaddress; string allhttp; string useragent;
                                        ...
                                        if ((userType.ToUpper() == "AGENT" || userType.ToUpper() == "ADMIN") && ForceUserChangePW)
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        ViewBag.IPAddresses = IPAddresses;
                                        //End User IP address etc
                                        log.ClientDetails = log.ClientDetails = ViewBag.macAdd + ";" + ViewBag.ipaddress + ";" + ViewBag.LOCAL + ";" + ViewBag.useragent + ";" + ViewBag.remoteaddr + ";" + ViewBag.REMOTE_HOST + ";" + ViewBag.REMOTE_PORT + ";" + ViewBag.HostName + ";" + ViewBag.myIPv6 + ";" + ViewBag.macAddresses + ";" + ViewBag.gatewayip + ";" + ViewBag.IPAddresses;
